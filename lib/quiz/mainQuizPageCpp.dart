...
class _MainQuizPageCppState extends State<MainQuizPageCpp> {
  ...
  Widget build(BuildContext context) {
    ...
    cppList.add(CppQuestion(
        question:
            'What is the correct value to return to the operating system upon the successful completion of a program?',
        option1: '-1',
        option2: '1',
        option3: '0',
        option4: 'Programs do not return a value.',
        answer: '0'));
    cppList.add(CppQuestion(
    ...
    cppList.add(CppQuestion(
        ...
        answer: '=='));
    cppList.add(CppQuestion(
        question: 'A protected member of the class in accessible in',
        option1: 'Only same class',
        option2: 'Same class and derived class',
        option3: 'Outside the class',
        option4: 'None of the above.',
        answer: 'Same class and derived class'));
    cppList.add(CppQuestion(
        question:
    ...
    cppList.add(CppQuestion(
        question:
            'While redefining a virtual function in the derived class, if its prototype is changed then ',
        option1: 'It will be overloaded by the compiler',
        option2: 'Its virtual nature will be lost',
        option3: 'both a and b',
        option4: 'Compiler will generate “Prototype mismatch error”',
        answer: 'both a and b'));
    cppList.add(CppQuestion(
        question:
